    ...
    <el-table v-loading="tableData.loading" @sort-change='sortTable' border table-layout="auto" stripe
      ...
      <el-table-column fixed="right" label="操作">
        ...
        <template #default="scope">
          ...
          <el-button type="primary" link @click="registerInfo(scope.row)" size="small">报名信息</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import BaseCourseFormVue from './Form.vue'
import UserRegisterTableVue from '../user/register-course/Table.vue'
...
const tableData = reactive({
 ...
 const registerInfo = (record) => {
   bus.emit('edit-item', {
     record,
     component: UserRegisterTableVue,
     title: `${record.courseName}课程报名信息`,
     name: record.id
   })
 }
...
bus.on('update-course-table', () => fetchListData())
</script>
<style>
