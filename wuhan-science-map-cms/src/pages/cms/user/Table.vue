...
import { listUser, deleteUserByIds, getUserConditions, getTableColumns, putUser } from 'src/api/user'
import UserFormVue from './Form.vue'
...
bus.on('update-user-table', () => fetchListData())
</script>
<style>
